      ...
      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-r from-[#2E7D32]/95 to-[#4CAF50]/95 backdrop-blur-sm py-2 md:py-3 overflow-hidden">
        <div className="animate-marquee whitespace-nowrap">
          ...
          <span className="text-white text-xs md:text-sm lg:text-base font-medium mx-3 md:mx-4 inline-flex items-center">
            ...
            • WELCOME TO THE OFFICIAL WEBSITE OF THE GENERAL DEPARTMENT OF
            PROJECT IMPACT RESOLUTION! •
          </span>
          <span className="text-white text-xs md:text-sm lg:text-base font-medium mx-3 md:mx-4 inline-flex items-center">
            <span className="w-1.5 h-1.5 bg-green-300 rounded-full mr-2"></span>
            ក្នុងនាមជាអគ្គនាយក ខ្ញុំមានសេចក្តីសោមនស្សរីករាយ
            សូមស្វាគមន៍យ៉ាងកក់ក្តៅ​ចំពោះ​ការចូលទស្សនា​គេហទំព័រនេះ • AS GENERAL
            DIRECTOR, I AM DELIGHTED TO WELCOME YOU TO THIS WEBSITE •
          </span>
          <span className="text-white text-xs md:text-sm lg:text-base font-medium mx-3 md:mx-4 inline-flex items-center">
            <span className="w-1.5 h-1.5 bg-green-300 rounded-full mr-2"></span>
            យើងខ្ញុំបានបង្កើតគេហទំព័រនេះឡើងដើម្បីផ្តល់ព័ត៌មានអំពីសកម្មភាព
            និងសេវាកម្មរបស់អគ្គនាយកដ្ឋាន • WE HAVE CREATED THIS WEBSITE TO
            PROVIDE INFORMATION ABOUT THE ACTIVITIES AND SERVICES OF THE GENERAL
            DEPARTMENT •
          </span>
          <span className="text-white text-xs md:text-sm lg:text-base font-medium mx-3 md:mx-4 inline-flex items-center">
            <span className="w-1.5 h-1.5 bg-green-300 rounded-full mr-2"></span>
            យើងប្តេជ្ញាផ្តល់សេវាកម្មប្រកបដោយតម្លាភាព យុត្តិធម៌
            និងប្រសិទ្ធភាពជូនប្រជាពលរដ្ឋ • WE ARE COMMITTED TO PROVIDING
            TRANSPARENT, FAIR, AND EFFICIENT SERVICES TO CITIZENS •
          </span>
          <span className="text-white text-xs md:text-sm lg:text-base font-medium mx-3 md:mx-4 inline-flex items-center">
            <span className="w-1.5 h-1.5 bg-green-300 rounded-full mr-2"></span>
