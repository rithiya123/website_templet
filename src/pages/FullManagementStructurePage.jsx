  ...
  const directorGeneral = {
    ...
    employment: [
      ...
      },
      {
        ...
        title: {
          km: "សមាជិកឧត្តមក្រុមប្រឹក្សាសេដ្ឋកិច្ចជាតិ (ឋានៈស្មើ រដ្ឋលេខាធិការ)",
          en: "Member of the Supreme National Economic Council (SNEC) (With the rank of Secretary of State)",
        },
      },
      {
        year: "2016 - 2021",
      ...
      },
      {
        year: "2015 - 2018",
        title: {
          km: "ទីប្រឹក្សាឧត្តមក្រុមប្រឹក្សាសេដ្ឋកិច្ចជាតិ (ឋានៈស្មើ អនុរដ្ឋលេខាធិការ)",
          en: "Advisor to the Supreme National Economic Council (With the rank of Under Secretary of State)",
        },
      },
      {
        year: "2011 - 2016",
    ...
    publications: [
      {
        year: "កុម្ភៈ ២០១៨",
        title: {
          km: "ការដាក់ឱ្យប្រើប្រាស់ស្តង់ដានីតិវិធីប្រតិបត្តិសម្រាប់ការងារដោះស្រាយផលប៉ះពាល់ដោយសារគម្រោងអភិវឌ្ឍន៍",
  ...
  const departments = [
    {
      ...
      head: { km: "លោក ពិន និលឡា", en: "លោក ពិន និលឡា" },
      email: "xxx@mef.gov.kh",
      phone: "(+855) xx xxx xxxx",
      image: logo,
    },
    {
      ...
      head: { km: "លោក សេង វណ្ណឌី", en: "លោក សេង វណ្ណឌី" },
      email: "xxx@mef.gov.kh",
      phone: "(+855) xx xxx xxxx",
      image: logo,
    },
    {
      ...
      head: { km: "លោក ស៊ន់ សេរីវឌ្ឍន:", en: "លោក ស៊ន់ សេរីវឌ្ឍន:" },
      email: "xxx@mef.gov.kh",
      phone: "(+855) xx xxx xxxx",
      image: logo,
    },
    {
      ...
      head: { km: "លោក គីម ច័ន្ទវិបុល", en: "លោក គីម ច័ន្ទវិបុល" },
      email: "xxxmef.gov.kh",
      phone: "(+855) xx xxx xxxx",
      image: logo,
    },
    {
      ...
      head: { km: "លោក គង់ រដ្ឋា", en: "លោក គង់ រដ្ឋា" },
      email: "xxx@mef.gov.kh",
      phone: "(+855) xx xxx xxxx",
      image: logo,
    },
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <nav className="flex items-center space-x-2 text-sm">
                <Link to="/" className="text-gray-500 hover:text-green-700">
                  {t.home}
                </Link>
      ...
      <Container className="py-4 pb-16">
        ...
        >
          ...
          <div className="flex justify-center mb-8">
            <div
              className="bg-green-50 border border-green-200 rounded-lg p-4 w-full max-w-md cursor-pointer hover:shadow-lg transition-shadow"
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-base font-semibold text-gray-900">
                    {directorGeneral.name[currentLang]}
                  </p>
                  <div className="flex items-center space-x-3 mt-2">
                    <a
                      href={`mailto:${directorGeneral.email}`}
                      className="text-green-500 hover:text-green-700"
                    >
                      <Mail size={14} />
                    </a>
                    <a
                      href={`tel:${directorGeneral.phone}`}
                      className="text-green-500 hover:text-green-700"
                    >
                      <Phone size={14} />
                    </a>
          ...
          <div className="mb-8">
            <h3 className="text-center text-sm font-medium text-green-700 mb-3">
              {t.deputyDirector}
            </h3>
            <div className="grid grid-cols-5 gap-3">
              {deputyDirectors.map((deputy) => (
                <div
                  ...
                  onClick={() => handleNodeClick(deputy)}
                >
                    ...
                    <div className="w-24 h-24 rounded-full bg-white overflow-hidden ring-4 ring-green-200 shadow-lg flex-shrink-0">
                      <img
                        ...
                        alt={
                          ...
                          selectedDept.title?.[currentLang]
                        }
                        className="w-full h-full object-cover"
                    ...
                    <div>
                      ...
                      {selectedDept.deputyHead && (
                        <p className="text-sm text-gray-600 mt-1">
                          ...
                          {selectedDept.deputyHead[currentLang]}
                        </p>
                      )}
                      {selectedDept.projectTypes && (
                        <div className="mt-2 inline-flex items-center space-x-1 bg-white/80 backdrop-blur-sm rounded-full px-3 py-1">
                          ...
                          <span className="text-xs font-medium text-gray-700">
                            {selectedDept.projectTypes[currentLang]}
                          </span>
                        </div>
                      )}
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                          <div>
                            ...
                            <p className="text-sm text-gray-800">
                              {selectedDept.personalInfo.name[currentLang]}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">{t.dob}</p>
                            <p className="text-sm text-gray-800">
                              {selectedDept.personalInfo.dob[currentLang]}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">{t.pob}</p>
                            <p className="text-sm text-gray-800">
                              {selectedDept.personalInfo.pob[currentLang]}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm text-gray-800">
                              {
                                selectedDept.personalInfo.nationality[
                                  currentLang
                                ]
                              }
                            </p>
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-800">
                              {
                                selectedDept.personalInfo.maritalStatus[
                                  currentLang
                                ]
                              }
                            </p>
                    ...
                    {selectedDept.coreFunctions && (
                      <div className="mb-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          {selectedDept.coreFunctions[currentLang].map(
                            (func, idx) => (
                              <div
                                key={idx}
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      <a
                        ...
                        className="flex items-center space-x-2 text-sm text-gray-600 hover:text-green-700 transition-colors"
                      >
