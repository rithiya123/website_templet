...
const RolesResponsibilitiesPage = () => {
  ...
  const departmentList = [
    { 
      id: 1,
      name: currentLang === "km" ? "នាយកដ្ឋានកិច្ចការទូទៅ" : "Department of General Affairs", 
      icon: <Building2 size={20} />,
      description: currentLang === "km" 
      ...
      responsibilities: currentLang === "km" ? [
      ...
      offices: currentLang === "km" ? [
        { name: "ការិយាល័យបុគ្គលិក រដ្ឋបាល និងហិរញ្ញវត្ថុ", icon: <Briefcase size={16} />, 
          duties: [
        ...
        { name: "ការិយាល័យផែនការ និងច្បាប់", icon: <Scale size={16} />,
          duties: [
        ...
        { name: "ការិយាល័យព័ត៌មានវិទ្យា", icon: <Laptop size={16} />,
          duties: [
        ...
        { name: "Office of Personnel, Administration and Finance", icon: <Briefcase size={16} />, 
          duties: [
        ...
        { name: "Office of Planning and Law", icon: <Scale size={16} />,
          duties: [
            "Compile and archive legal documents and legal standards",
        ...
        { name: "Office of Information Technology", icon: <Laptop size={16} />,
          duties: [
    ...
    { 
      id: 2,
      name: currentLang === "km" ? "នាយកដ្ឋានដោះស្រាយផលប៉ះពាល់ទី ១" : "Impact Resolution Department 1", 
      icon: <Building2 size={20} />,
      description: currentLang === "km" 
      ...
      offices: currentLang === "km" ? [
        { name: "ការិយាល័យគម្រោងវិនិយោគសាធារណៈក្នុងស្រុក និងគម្រោងអភិវឌ្ឍន៍ឯកជនទី ១", icon: <Landmark size={16} />, 
          duties: [
        ...
        { name: "ការិយាល័យគម្រោងសហប្រតិបត្តិការទី ១", icon: <Link2 size={16} />,
          duties: [
        ...
        { name: "ការិយាល័យគម្រោងសហប្រតិបត្តិការពហុភាគីទី ១", icon: <Globe size={16} />,
          duties: [
        ...
        { name: "Office of Domestic Public Investment and Private Development Projects 1", icon: <Landmark size={16} />, 
          duties: [
        ...
        { name: "Office of Cooperation Projects 1", icon: <Link2 size={16} />,
          duties: [
        ...
        { name: "Office of Multilateral Cooperation Projects 1", icon: <Globe size={16} />,
          duties: [
    ...
    { 
      id: 3,
      name: currentLang === "km" ? "នាយកដ្ឋានដោះស្រាយផលប៉ះពាល់ទី ២" : "Impact Resolution Department 2", 
      icon: <Building2 size={20} />,
      description: currentLang === "km" 
      ...
      offices: currentLang === "km" ? [
        { name: "ការិយាល័យគម្រោងវិនិយោគសាធារណៈក្នុងស្រុក និងគម្រោងអភិវឌ្ឍន៍ឯកជនទី ២", icon: <Landmark size={16} />, 
          duties: [
        ...
        { name: "ការិយាល័យគម្រោងសហប្រតិបត្តិការទី ២", icon: <Link2 size={16} />,
          duties: [
        ...
        { name: "ការិយាល័យគម្រោងសហប្រតិបត្តិការពហុភាគីទី ២", icon: <Globe size={16} />,
          duties: [
        ...
        { name: "Office of Domestic Public Investment and Private Development Projects 2", icon: <Landmark size={16} />, 
          duties: [
        ...
        { name: "Office of Cooperation Projects 2", icon: <Link2 size={16} />,
          duties: [
        ...
        { name: "Office of Multilateral Cooperation Projects 2", icon: <Globe size={16} />,
          duties: [
    ...
    { 
      id: 4,
      name: currentLang === "km" ? "នាយកដ្ឋានដោះស្រាយផលប៉ះពាល់ទី ៣" : "Impact Resolution Department 3", 
      icon: <Building2 size={20} />,
      description: currentLang === "km" 
      ...
      offices: currentLang === "km" ? [
        { name: "ការិយាល័យគម្រោងវិនិយោគសាធារណៈក្នុងស្រុក និងគម្រោងអភិវឌ្ឍន៍ឯកជនទី ៣", icon: <Landmark size={16} />, 
          duties: [
            "ចូលរួមសហការជាមួយក្រសួងស្ថាប័នពាក់ព័ន្ធ",
            "ចូលរួមចរចាកិច្ចព្រមព្រៀងហិរញ្ញប្បទាន",
            "រៀបចំក្រុមការងារចុះអនុវត្តការងារ"
          ] },
        { name: "ការិយាល័យគម្រោងសហប្រតិបត្តិការទី ៣", icon: <Link2 size={16} />,
          duties: [
            "ពិនិត្យ ផ្តល់យោបល់ និងរៀបចំស្នើសុំការអនុម័ត",
            "រៀបចំផែនការមេ",
            "រៀបចំកិច្ចប្រជុំពិគ្រោះយោបល់"
          ] },
        { name: "ការិយាល័យគម្រោងសហប្រតិបត្តិការពហុភាគីទី ៣", icon: <Globe size={16} />,
          duties: [
            "ផ្ទៀងផ្ទាត់ និងគ្រប់គ្រងទិន្នន័យផលប៉ះពាល់",
            "រៀបចំសំណើសុំកញ្ចប់ថវិកា",
        ...
        { name: "Office of Domestic Public Investment and Private Development Projects 3", icon: <Landmark size={16} />, 
          duties: [
        ...
        { name: "Office of Cooperation Projects 3", icon: <Link2 size={16} />,
          duties: [
            "Review, provide comments, and prepare approval requests",
            "Prepare master plans",
            "Organize consultation meetings"
          ] },
        { name: "Office of Multilateral Cooperation Projects 3", icon: <Globe size={16} />,
          duties: [
            "Verify and manage impact data",
            "Prepare budget package requests",
    ...
    { 
      id: 5,
      name: currentLang === "km" ? "នាយកដ្ឋានត្រួតពិនិត្យផ្ទៃក្នុង និងគ្រប់គ្រងទិន្នន័យ" : "Department of Internal Inspection and Data Management", 
      icon: <Building2 size={20} />,
      description: currentLang === "km" 
      ...
      offices: currentLang === "km" ? [
        { name: "ការិយាល័យត្រួតពិនិត្យផ្ទៃក្នុង", icon: <UserCheck size={16} />, 
          duties: [
        ...
        { name: "ការិយាល័យគ្រប់គ្រងទិន្នន័យ", icon: <Database size={16} />,
          duties: [
            "សហការជាមួយការិយាល័យបច្ចេកវិទ្យាព័ត៌មាន",
            "គ្រប់គ្រងរាល់ទិន្នន័យផលប៉ះពាល់",
            "ផ្តល់ការគាំទ្រដល់ការិយាល័យត្រួតពិនិត្យផ្ទៃក្នុង"
          ] },
        { name: "ការិយាល័យទទួលពាក្យបណ្តឹង និងទំនាក់ទំនងសាធារណៈ", icon: <MessageCircle size={16} />,
          duties: [
        ...
        { name: "Office of Internal Inspection", icon: <UserCheck size={16} />, 
          duties: [
        ...
        { name: "Office of Data Management", icon: <Database size={16} />,
          duties: [
            "Cooperate with Office of Information Technology",
            "Manage all impact data",
            "Provide support to the Internal Inspection Office"
          ] },
        { name: "Office of Complaint Reception and Public Relations", icon: <MessageCircle size={16} />,
          duties: [
        ...
        <div className="min-h-screen px-3 sm:px-4 py-4 sm:py-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              {selectedDepartment.responsibilities && selectedDepartment.responsibilities.length > 0 && (
                <div className="bg-gray-50 rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <Target size={18} className="text-[#2E7D32]" />
                    <h2 className="text-base font-medium text-gray-900">{t.responsibilities}</h2>
                  </div>
                  <div className="grid md:grid-cols-2 gap-3">
                    {selectedDepartment.responsibilities.map((item, idx) => (
                      <div key={idx} className="flex items-start gap-2">
                        <ChevronRight size={14} className="text-[#4CAF50] mt-0.5 flex-shrink-0" />
              ...
              {/* Offices Section */}
              {selectedDepartment.offices && selectedDepartment.offices.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    <Building2 size={18} className="text-[#2E7D32]" />
                    <h2 className="text-base font-medium text-gray-900">{t.offices}</h2>
                  </div>
                  <div className="grid md:grid-cols-3 gap-4">
                    {selectedDepartment.offices.map((office, idx) => (
                      <div key={idx} className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-all">
                        <div className="flex items-center gap-2 mb-3">
                          <div className="p-1.5 bg-[#4CAF50] bg-opacity-10 rounded-lg text-[#2E7D32]">
                            {office.icon}
                          </div>
                          <h3 className="text-sm font-medium text-gray-900">{office.name}</h3>
                        </div>
                        {office.duties && office.duties.length > 0 && (
                          <>
                            <div className="text-xs font-medium text-gray-500 mb-2">{t.officeDuties}:</div>
                            <ul className="space-y-1.5">
                              {office.duties.map((duty, dutyIdx) => (
                                <li key={dutyIdx} className="flex items-start gap-1.5 text-xs text-gray-500">
                                  <ChevronRight size={10} className="text-[#4CAF50] mt-0.5 flex-shrink-0" />
                                  <span>{duty}</span>
                                </li>
                              ))}
                            </ul>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        <ChevronRight size={16} className="text-gray-400 group-hover:text-[#4CAF50] group-hover:translate-x-1 transition-all" />
                      </div>
                    </div>
                  </div>
                </div>
